          ...
          <div>
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-green-50 rounded-lg p-4 border border-emerald-200">
              <div className="space-y-2 mb-4">
                ...
                {isInstallment && (
                  <div className="flex justify-between border-t pt-2 border-emerald-300">
                    <span className="text-sm">Рассрочка 13% (комиссия Kaspi)</span>
                    <span className="text-sm font-medium">{formatPrice(Math.round((installmentAmount > 0 ? installmentAmount : result.total) * 0.13))} ₸</span>
                  </div>
                )}
              </div>
